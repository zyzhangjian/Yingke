...
+ (UIColor *)colorWithColor:(UIColor *)color
    ...
    CGFloat fRed, fGreen, fBlud, fAlpha;
    [color getRed:&fRed green:&fGreen blue:&fBlud alpha:&fAlpha];
    
    UIColor *newColor = [UIColor colorWithRed:fRed   + red  /255.0
                                        green:fGreen + green/255.0
                                         blue:fBlud  + blue /255.0
                                        alpha:fAlpha + alpha/255.0];
    return newColor;
}
